...
import 'compoents/custom_details_widget.dart';

class ScreenBusinessDetails extends StatelessWidget {
  ScreenBusinessDetails({super.key, required this.index});
        ...
        children: [
          Column(
            children: [
              ...
              Image.asset("assets/images/busines.png"),
              Card(
                color: cardBgColor,
